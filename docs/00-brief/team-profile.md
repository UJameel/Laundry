---
tags: [hackathon, team, valon]
status: reviewed
created: 2026-04-03
source: User input
valon-skill: team-profile
---
...
| Member | Primary | Tools | AI Tool | Domain |
|--------|---------|-------|---------|--------|
...
**Primary approach:** Vibe-coding with Claude Code + GSD framework. Heavy use of sponsor tools (Lovable for UI, n8n for backend, Crossmint + MiniMax for differentiation).

## Strengths
- **AI-assisted development velocity.** Claude Code + GSD = fast execution with structured task management
...
- **Lean hard on AI coding tools.** With Claude Code + GSD, you can ship faster than teams hand-coding. Use this speed advantage.
- **Use Lovable for ALL frontend.** Don't hand-code React. Let Lovable generate it, Tej polishes in Figma/Lovable editor.
- **Keep Crossmint integration simple.** One wallet + one transaction demo is enough. Don't build a full payment system.
